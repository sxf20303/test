...
/*		if (listener == null)
    ...
    public synchronized void register() {
        if (mPermissionIntent == null) {
            ...
            mDeviceCounts = 0;
            mHandler.postDelayed(mDeviceCheckRunnable, 1000);//每2000ms检测一次是否有设备连接
        }
    }
    ...
    public synchronized void requestPermission(final UsbDevice device) {
        ...
        if (mPermissionIntent != null) {
            ...
            throw new Error("please call register method before requestPermission");
        }
    }
    ...
    private final void processConnect(final UsbDevice device) {
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                ctrlBlock = mCtrlBlocks.get(device);                   //  得到 USB 设备
                if (ctrlBlock == null) {
    ...
    private final void processAttach(final UsbDevice device) {
        ...
        if (mOnDeviceConnectListener != null) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    mOnDeviceConnectListener.onAttach(device); //  TODO
                }
            });
        }
    }
    ...
    public static final class UsbControlBlock {
        ...
        /**
         * onClose specified interface. USB device itself still keep open.
         * @param interfaceIndex
         */
        ...
        public synchronized void close() {
            if (DEBUG) Log.i(TAG, "UsbControlBlock#onClose:");
